...
Next, we noticed that another one of our variables of interest, *Isolation.source*, is very messy. Because this variable is sourced from text input, each category has many different variations based on terms used, capitalization, punctuation, etc. There are a total of 657 different categories in our data for this variable. As a result, we are going to look at the most frequently used words in *Isolation.source* and create a new variable called *Source*. Using these key terms, our variable *Isolation.type* (which can help to differentiate human cases because type will be clinical), and our general knowledge of Campylobacter sources, we regroup this variable to include 7 categories: Chicken, Cattle, Dairy, Pig, Turkey, Human, and Other. We will not distinguish between animal meat and live animals for our sources, because our text mining will likely be more inaccurate and both sources are likely to have the same effect on human outbreaks.
...
isolates$State[is.na(isolates$State)] <- "Other"
...
```{r}
# Change missing SNP.cluster to "Other"
isolates$SNP.cluster[is.na(isolates$SNP.cluster)] <- "Other"
```

```{r}
#Create Season variable
isolates<- isolates%>%mutate(Season=case_when(
...
```{r}
#Create Temperature variable (sources: https://www.currentresults.com/Weather/, https://www.climatestotravel.com/climate/puerto-rico)
isolates<-isolates%>%mutate(temperature=case_when(
  Season=="Spring"&State=="AL"~16.9,
  Season=="Spring"&State=="AK"~-4.1,
  Season=="Spring"&State=="AR"~16.3,
  Season=="Spring"&State=="AZ"~14.6,
  Season=="Spring"&State=="CA"~13.9,
  Season=="Spring"&State=="CO"~6.5,
  Season=="Spring"&State=="CT"~8.5,
  Season=="Spring"&State=="FL"~21.1,
  Season=="Spring"&State=="GA"~17.3,
  Season=="Spring"&State=="ID"~6.4,
  Season=="Spring"&State=="IL"~10.9,
  Season=="Spring"&State=="IN"~10.6,
  Season=="Spring"&State=="IA"~9.0,
  Season=="Spring"&State=="KS"~12.0,
  Season=="Spring"&State=="KY"~12.8,
  Season=="Spring"&State=="MD"~11.6,
  Season=="Spring"&State=="MA"~7.6,
  Season=="Spring"&State=="MI"~5.9,
  Season=="Spring"&State=="MN"~5.5,
  Season=="Spring"&State=="MO"~12.4,
  Season=="Spring"&State=="MT"~5.8,
  Season=="Spring"&State=="NE"~9.0,
  Season=="Spring"&State=="NV"~8.9,
  Season=="Spring"&State=="NH"~5.8,
  Season=="Spring"&State=="NJ"~10.3,
  Season=="Spring"&State=="NY"~6.4,
  Season=="Spring"&State=="NC"~14.6,
  Season=="Spring"&State=="ND"~5.1,
  Season=="Spring"&State=="OH"~9.8,
  Season=="Spring"&State=="OR"~8.3,
  Season=="Spring"&State=="PA"~8.6,
  Season=="Spring"&State=="PR"~26.7,
  Season=="Spring"&State=="RI"~8.3,
  Season=="Spring"&State=="SC"~16.7,
  Season=="Spring"&State=="SD"~7.1,
  Season=="Spring"&State=="TN"~14.1,
  Season=="Spring"&State=="TX"~18.4,
  Season=="Spring"&State=="UT"~8.6,
  Season=="Spring"&State=="VT"~5.3,
  Season=="Spring"&State=="VA"~12.3,
  Season=="Spring"&State=="WA"~8.7,
  Season=="Spring"&State=="WV"~10.5,
  Season=="Spring"&State=="WI"~6.1,
  Season=="Spring"&State=="WY"~4.9,
  Season=="Spring"&State=="LA"~19.1,
  Season=="Spring"&State=="OK"~15.1,
  Season=="Spring"&State=="MS"~17.3,
  Season=="Spring"&State=="DE"~11.8,
  Season=="Spring"&State=="NM"~11.3,
  Season=="Spring"&State=="HI"~20.3,
  Season=="Spring"&State=="ME"~3.9,
  Season=="Winter"&State=="AL"~8.1,
  Season=="Winter"&State=="AK"~-16.3,
  Season=="Winter"&State=="AR"~5.3,
  Season=="Winter"&State=="AZ"~6.4,
  Season=="Winter"&State=="CA"~7.9,
  Season=="Winter"&State=="CO"~-3.4,
  Season=="Winter"&State=="CT"~-1.9,
  Season=="Winter"&State=="FL"~15.2,
  Season=="Winter"&State=="GA"~8.8,
  Season=="Winter"&State=="ID"~-3.7,
  Season=="Winter"&State=="IL"~-2.1,
  Season=="Winter"&State=="IN"~-1.4,
  Season=="Winter"&State=="IA"~-5.7,
  Season=="Winter"&State=="KS"~-0.1,
  Season=="Winter"&State=="KY"~2.2,
  Season=="Winter"&State=="MD"~1.5,
  Season=="Winter"&State=="MA"~-2.6,
  Season=="Winter"&State=="MI"~-5.7,
  Season=="Winter"&State=="MN"~-10.9,
  Season=="Winter"&State=="MO"~0.2,
  Season=="Winter"&State=="MT"~-6.0,
  Season=="Winter"&State=="NE"~-3.5,
  Season=="Winter"&State=="NV"~0.1,
  Season=="Winter"&State=="NH"~-6.1,
  Season=="Winter"&State=="NJ"~0.6,
  Season=="Winter"&State=="NY"~-4.8,
  Season=="Winter"&State=="NC"~5.6,
  Season=="Winter"&State=="ND"~-11.0,
  Season=="Winter"&State=="OH"~-1.4,
  Season=="Winter"&State=="OR"~1.1,
  Season=="Winter"&State=="PA"~-2.0,
  Season=="Winter"&State=="PR"~26.0,
  Season=="Winter"&State=="RI"~-0.3,
  Season=="Winter"&State=="SC"~7.8,
  Season=="Winter"&State=="SD"~-6.9,
  Season=="Winter"&State=="TN"~3.9,
  Season=="Winter"&State=="TX"~8.8,
  Season=="Winter"&State=="UT"~-2.1,
  Season=="Winter"&State=="VT"~-7.0,
  Season=="Winter"&State=="VA"~2.7,
  Season=="Winter"&State=="WA"~0.6,
  Season=="Winter"&State=="WV"~0.4,
  Season=="Winter"&State=="WI"~-8.2,
  Season=="Winter"&State=="WY"~-6.0,
  Season=="Winter"&State=="LA"~10.5,
  Season=="Winter"&State=="OK"~3.9,
  Season=="Winter"&State=="MS"~8.2,
  Season=="Winter"&State=="DE"~2.3,
  Season=="Winter"&State=="NM"~2.3,
  Season=="Winter"&State=="HI"~19.7,
  Season=="Winter"&State=="ME"~-8.4,
  Season=="Summer"&State=="AL"~25.9,
  Season=="Summer"&State=="AK"~11.3,
  Season=="Summer"&State=="AR"~26.0,
  Season=="Summer"&State=="AZ"~25.6,
  Season=="Summer"&State=="CA"~23.0,
  Season=="Summer"&State=="CO"~18.4,
  Season=="Summer"&State=="CT"~20.7,
  Season=="Summer"&State=="FL"~27.2,
  Season=="Summer"&State=="GA"~25.9,
  Season=="Summer"&State=="ID"~17.6,
  Season=="Summer"&State=="IL"~23.0,
  Season=="Summer"&State=="IN"~22.4,
  Season=="Summer"&State=="IA"~22.0,
  Season=="Summer"&State=="KS"~24.7,
  Season=="Summer"&State=="KY"~23.6,
  Season=="Summer"&State=="MD"~22.9,
  Season=="Summer"&State=="MA"~20.0,
  Season=="Summer"&State=="MI"~19.0,
  Season=="Summer"&State=="MN"~19.3,
  Season=="Summer"&State=="MO"~24.1,
  Season=="Summer"&State=="MT"~17.9,
  Season=="Summer"&State=="NE"~22.1,
  Season=="Summer"&State=="NV"~20.6,
  Season=="Summer"&State=="NH"~18.6,
  Season=="Summer"&State=="NJ"~22.3,
  Season=="Summer"&State=="NY"~19.2,
  Season=="Summer"&State=="NC"~24.3,
  Season=="Summer"&State=="ND"~19.2,
  Season=="Summer"&State=="OH"~21.6,
  Season=="Summer"&State=="OR"~17.6,
  Season=="Summer"&State=="PA"~20.3,
  Season=="Summer"&State=="PR"~28.5,
  Season=="Summer"&State=="RI"~20.4,
  Season=="Summer"&State=="SC"~25.8,
  Season=="Summer"&State=="SD"~21.1,
  Season=="Summer"&State=="TN"~24.2,
  Season=="Summer"&State=="TX"~27.3,
  Season=="Summer"&State=="UT"~20.9,
  Season=="Summer"&State=="VT"~18.4,
  Season=="Summer"&State=="VA"~22.9,
  Season=="Summer"&State=="WA"~17.7,
  Season=="Summer"&State=="WV"~21.2,
  Season=="Summer"&State=="WI"~19.3,
  Season=="Summer"&State=="WY"~17.5,
  Season=="Summer"&State=="LA"~27.3,
  Season=="Summer"&State=="OK"~26.4,
  Season=="Summer"&State=="MS"~26.4,
  Season=="Summer"&State=="DE"~23.4,
  Season=="Summer"&State=="NM"~21.9,
  Season=="Summer"&State=="HI"~22.3,
  Season=="Summer"&State=="ME"~17.6,
  Season=="Fall"&State=="AL"~17.6,
  Season=="Fall"&State=="AK"~-2.9,
  Season=="Fall"&State=="AR"~16.3,
  Season=="Fall"&State=="AZ"~16.3,
  Season=="Fall"&State=="CA"~16.1,
  Season=="Fall"&State=="CO"~7.7,
  Season=="Fall"&State=="CT"~10.7,
  Season=="Fall"&State=="FL"~22.6,
  Season=="Fall"&State=="GA"~18.1,
  Season=="Fall"&State=="ID"~7.1,
  Season=="Fall"&State=="IL"~12.1,
  Season=="Fall"&State=="IN"~12.1,
  Season=="Fall"&State=="IA"~9.9,
  Season=="Fall"&State=="KS"~13.0,
  Season=="Fall"&State=="KY"~13.9,
  Season=="Fall"&State=="MD"~13.4,
  Season=="Fall"&State=="MA"~10.2,
  Season=="Fall"&State=="MI"~8.5,
  Season=="Fall"&State=="MN"~6.4,
  Season=="Fall"&State=="MO"~13.3,
  Season=="Fall"&State=="MT"~6.1,
  Season=="Fall"&State=="NE"~9.7,
  Season=="Fall"&State=="NV"~10.1,
  Season=="Fall"&State=="NH"~7.9,
  Season=="Fall"&State=="NJ"~12.7,
  Season=="Fall"&State=="NY"~8.9,
  Season=="Fall"&State=="NC"~15.7,
  Season=="Fall"&State=="ND"~5.6,
  Season=="Fall"&State=="OH"~11.6,
  Season=="Fall"&State=="OR"~9.4,
  Season=="Fall"&State=="PA"~10.5,
  Season=="Fall"&State=="PR"~27.9,
  Season=="Fall"&State=="RI"~11.7,
  Season=="Fall"&State=="SC"~17.4,
  Season=="Fall"&State=="SD"~8.0,
  Season=="Fall"&State=="TN"~14.8,
  Season=="Fall"&State=="TX"~18.6,
  Season=="Fall"&State=="UT"~9.5,
  Season=="Fall"&State=="VT"~7.6,
  Season=="Fall"&State=="VA"~13.6,
  Season=="Fall"&State=="WA"~9.2,
  Season=="Fall"&State=="WV"~11.8,
  Season=="Fall"&State=="WI"~7.6,
  Season=="Fall"&State=="WY"~5.8,
  Season=="Fall"&State=="LA"~19.7,
  Season=="Fall"&State=="OK"~15.9,
  Season=="Fall"&State=="MS"~17.9,
  Season=="Fall"&State=="DE"~14.1,
  Season=="Fall"&State=="NM"~12.1,
  Season=="Fall"&State=="HI"~22.1,
  Season=="Fall"&State=="ME"~6.8))
```

Lastly, we want to create our outcome of interest, *Outbreak*. Because the "Outbreak" variable that came with our dataset is more than 99% missing, we have to create it from scratch. We will be using data on Campylobacter jejuni outbreaks in the US from 2012-2020 from the CDC's National Outbreak Reporting System (NORS) Dashboard to create our variable. In this dataset, we have data on the state, month, and year for all 592 Campylobacter jejuni outbreaks that occurred in the US from 2012-2020. If there are isolates in the same exact time and state as an outbreak as recorded by the CDC that are within the same SNP cluster and have a minimum SNP distance of less than 8 within the cluster, they are considered to be part of an outbreak. As a result, our variable *Outbreak* will be equal to 1 if the isolate seems to be linked to an outbreak, and will be equal to 0 otherwise. 
...
outbreaks$State[outbreaks$State == "Arkansas"] <- "AR"
...
isolates$Season <- factor(isolates$Season)
```
...
```{r}
isolates <- isolates %>%
  mutate(missing_bin = as.numeric(rowSums(is.na(isolates)) > 0))

t1 <- CreateTableOne(data = isolates,
               strata = c("missing_bin"),
               vars = c("Isolation.type",
                        "Min.same",
                        "Min.diff",
                        "Year",
                        "Month",
...
# Converting our TableOne object into a dataframe and removing "test" column
# because it is empty
as.data.frame(print(t1))
...
In the final dataset we have 43089 observations of 13 variables (Strain, Isolate.identifiers and Isolation.type, SNP.cluster, Min.same and Min.diff, AMR.genotypes, Year, Month, Source, State, and Outbreak).

**Isolation.type**
The dataset consists of 36% clinical isolates and 64% environmental isolates (the number of missing values is small - 51 observation). 

**Source**
In terms of environmental source the highest number of isolates was collected from chicken (17296), followed by cattle (6739) and pig (1602); the smallest number - from dairy (88 isolates). It is important to mention that the dataset does not contain many isolates from water sources that also is a high-risk source of infection, these samples have been grouped into the "Other" category.

**SNP.cluster**
The isolates were classified to 3848 SNP.clusters with maximum number of 1030 isolates, average number - 11, and median 3 isolates. Slightly more than 7 thousand isolates were not classified to any cluster. Taking into account that some clusters may contain both types of isolates, and some - only one type, the number of mission values in Min.diff and Min.same is higher than in SNP.cluster (15712 and 7754 isolates respectively).

**Year**
The dataset contains isolates from all 9 years included into research though the distribution is not equal with the lowest number of isolates in 2012(less than 0.05%) and the highest in 2019 (28%).

**Month**
The distribution of cases by month varies from 6.5% in February to almost 12% in April. The most number of isolates were collected in spring and summer (~11,500 per each season), and slightly less in fall (~ 10,700), and winter (~9,200).

**State**
The isolates were collected in all states though in some states only few isolates were collected: the smallest number in Nevada (3), Alaska (4), Hawaii(14),North Dakota (11), Montana(28), New Hampshire(28); and the highest number of isolates - in Texas(1892), Georgia (2443), and California (2124).

1844 isolates were assigned to outbreaks, representing 607 clusters in total.

```{r, include = FALSE}
#Overall database
str(isolates)
# check the no. of observations of the data
dim(isolates)
...
isolates$Isolate<-as.factor(isolates$Isolate)
# plot graphs for visual representation of the data
# check distribution of the sources of the isolates data
ggplot(data = isolates, 
       aes(x= Source))+
  geom_bar(fill= "blue")+
  theme_gray() +
labs(title = "Distribution of Sources in the data", x= "Sources", y= "frequency")
```

```{r, include=FALSE}
# view which year was the most prevalent as per the data
ggplot(data = isolates, 
       aes(x= Year))+
  geom_bar(fill= "red")+
  theme_gray() +
  labs(title = "A graph of distribution of years", x= "Years", y= "frequency")
```

```{r, include = FALSE}
# check the isolation type based on the data using a bar graph
ggplot(data = isolates,
       aes(x= Isolation.type, fill= Year))+
  geom_bar(position = "dodge")+
  theme_gray() +
  labs(title = "Frequency of Isolation types by years", x= "Isolation Type", y= "Frequency")
```
  

```{r, include = FALSE}
# Summary and missing values observed per variable
summary(isolates)
apply(isolates, 2, function(x){return(sum(is.na(x)))})
#strain
# structure of data by strain
str(isolates$Strain)
# sum of missing value counts in strain
sum(is.na(isolates$Strain))
#Isolate
# structure of data by Isolate
str(isolates$Isolate)
# sum of missing value counts in Isolate
sum(is.na(isolates$Isolate))
#Isolate.identifier
# structure of data by Isolate.identifier
str(isolates$Isolate.identifiers)
# sum of missing value counts in Isolate.identifier
sum(is.na(isolates$Isolate.identifiers))
#Isolation.type
isolates%>%group_by(Isolation.type)%>%summarize(n=n()/43089)
#SNP.cluster
#Number of clusters and their size
isolates%>%group_by(SNP.cluster)%>%summarize(size=n())%>%arrange(desc(size))%>%summary(size)
#AMR.genotypes
# structure of data by AMR.genotypes
str(isolates$AMR.genotypes)
# sum of missing value counts in AMR.genotypes
sum(is.na(isolates$AMR.genotypes))
#Year
year<-isolates%>%group_by(Year)%>%summarize(num=n()/43089)
#Month
isolates%>%group_by(Month)%>%summarize(n=n()/43089)
isolates%>%group_by(Season)%>%
  summarize(n=n())
#State
isolates%>%group_by(State)%>%summarize(num=n())%>%
print(n=52)
#Source
isolates%>%group_by(Source)%>%summarize(num=n())%>%
  print(n=20)
#Outbreak
isolates%>%group_by(Outbreak)%>%summarize(n=n())
isolates%>%filter(Outbreak=="1")%>%group_by(SNP.cluster)%>%summarize(n=n())%>%summary(n)
```
...
```{r}
# Create custom test fisher test with simulate.p.value = TRUE for use for
# 'Source' variable in tbl_summary bc sample size was too small
FT.simulate.p.values <- function(data, variable, by, ...) {
  result <- list()
  test_results <- stats::fisher.test(data[[variable]],
                                     data[[by]], 
...
# Create table of variable statistics stratified by 'Outbreak'
isolates %>%
  ...
  tbl_summary(by = Outbreak,
              ...
              digits = list(all_continuous() ~ 2,
                            all_categorical() ~ 2)) %>%
  add_p(test = Source ~ "FT.simulate.p.values") %>%
...
For this project, our intial objective was to identify high-risk sources of Campylobacter jejuni infection and times of the year that have a high likelihood of seeing an outbreak. After exploring our data, we believe that a potential proposed direction would be to conduct a logistic regression model on our outcome of interest, *Outbreak*. We have created our outcome variable in a way where it would make sense to use this method of analysis. One of the main limitations of our project will be dealing with data that is not missing at random. In future research, we plan to learn more about ways to deal with MNAR data and see if we can implement these in our project. While we were originally interested in times of year and sources as the main explanatory variables, we have discovered a number of other variables of interest that may be related to outbreaks through our analysis. We would like to explore this more in the future and potentially determine the relationship between these variables and outbreaks as a secondary objective.
...
```{r, include=FALSE}
write.csv(isolates, "~/Desktop/isolates_clean.csv")
```
