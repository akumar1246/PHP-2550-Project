...
library(zoo)
#Read in data
isolates <- read.csv("/Users/anushakumar/Documents/Grad School Documents (Macbook)/PHP 2550/Project/isolates .csv", na.strings=c("","NA"))
```
...
```{r}
outbreaks <- read.csv("https://raw.githubusercontent.com/akumar1246/PHP-2550-Project/main/data/NationalOutbreakPublicDataTool.csv")
...
Looking at the differences in the most frequently seen clusters, it appears that SNP clusters PDS000022633.149, PDS000107294.12, PDS000073565.28, and PDS000022710.75 may be more associated with outbreaks. As a result, we conclude that this variable seems to have a relationship with outbreak.
...
Looking at the differences in the most frequently seen AMR genotypes, it appears that genotypes "aph(3')-IIIa=COMPLETE,blaOXA-193=COMPLETE,gyrA_T86I=POINT,tet(O)=COMPLETE" and "50S_L22_A103V=POINT,tet(O)=COMPLETE" may be more associated with outbreaks. As a result, we conclude that this variable seems to have a relationship with outbreak.
